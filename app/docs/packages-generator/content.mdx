...
<Callout type="warning" title="For Learning & Prototyping Only">
...
For **production applications**, use the **[@paljs/plugins](/docs/packages-plugins)** package with PrismaSelect instead — it gives you optimized queries while you maintain full control over your API.
</Callout>
